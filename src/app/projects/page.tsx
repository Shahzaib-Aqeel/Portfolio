...
export default function ProjectsPage() {
  return (
    <main className="bg-[#030F18]">
      ...
      <div className="min-h-screen w-full mt-24 text-white px-4 sm:px-10">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-8">
          ...
          <p
            ...
            className="text-gray-300 text-base sm:text-lg text-center sm:text-left"
          >
        ...
        <div className="flex sm:flex-row flex-col items-center sm:justify-between sm:mt-20 pb-20 gap-10 sm:mx-30">
          <Link
          ...
          >
            ...
            />
            <h1 className="text-2xl">RA STORE</h1>
            <p
              style={{ fontFamily: "Arial, sans-serif" }}
...
"
          ...
          >
            <Image
              ...
              className="hover:scale-105 transition-transform duration-300"
            />
            <h1 className="text-2xl">DEVNOTES</h1>
            <p
              style={{ fontFamily: "Arial, sans-serif" }}
              className="text-gray-300"
            >
