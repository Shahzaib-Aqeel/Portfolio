...
export default function ContactForm() {
  ...
  return (
    <div
      className="sm:w-150 w-full sm:h-200 h-160 bg-[#01060A] rounded-2xl mt-10 sm:mt-0 mb-10 sm:mb-0"
      style={{ fontFamily: "Arial, sans-serif" }}
    >
      <form
        ref={formRef}
        onSubmit={handleSubmit}
        className="flex flex-col items-start justify-center p-10 space-y-6"
      >
        ...
        <input
          ...
          type="text"
          placeholder="Name"
          className="w-full sm:h-15 h-10 bg-[#0E1316] rounded-lg px-4 text-white focus:outline-none"
        />
        ...
        <textarea
          ...
          className="w-full sm:h-36 h-26 bg-[#0E1316] rounded-lg px-4 pt-6 text-white focus:outline-none peer"
        ></textarea>
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-linear-to-r from-gray-300 to-gray-100 text-[#001F3F] text-base sm:px-23 w-full sm:py-4 py-3 rounded-4xl cursor-pointer
